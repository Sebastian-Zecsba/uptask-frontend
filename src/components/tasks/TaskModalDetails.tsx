...
import { statusTransLatios } from '@/locales/es';
...
export default function TaskModalDetails() {
    ...
    const taskId = quertParams.get('viewTask')!
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                            ...
                                            <ul className='list-decimal'>
                                                {data.completedBy.map((activityLog) => (
                                                    <li key={activityLog._id}>
                                                        <span className='font-bold text-slate-600'>{statusTransLatios[activityLog.status]}</span>{' '} por: 
                                    ...
                                    <div className='my-5 space-y-3'>
                                        ...
                                        >
                                            {Object.entries(statusTransLatios).map(([key, value]) => (
