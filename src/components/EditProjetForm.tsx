...
const EditProjetForm = ({data, projectId} : EditProjetFormProps) => {
    ...
    return (
        <>
          <div className="max-w-3xl mx-auto">
            ...
            <nav className="my-5">
                <Link
                    className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl font-bold curor-pointer transition-colors"
                    to="/"
                >
                    Volver a proyectos
                </Link>
